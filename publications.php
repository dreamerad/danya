...
$sth = $dbh->prepare("SELECT * FROM articles WHERE user_email = :user_email");
$sth->execute([
    ...
    <section class="s-content">
        ...
        <div class="row narrow">
            <div class="col-full s-content__header" data-aos="fade-up">
                ...
                <a href="/add.php">Добавить публикацию</a> 
                    ...
                    <div class="entry__text">
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                ...
                                <a href="/publications.php?delete='.$val['id'].'">Удалить</a>
                            </span>';
                            if($val['status'] == 0) {
                                echo '<p>На модерации</p>';
                            }
                            else if ($val['status'] == 1) {
                                echo '<p style="color: green;">Одобрено</p>';
                            }
                            else if ($val['status'] == 2) {
                                echo '<p style="color: red;">Отказано</p>';
                            }
                            echo '
                        </div>
                    </div>
